...
namespace ACR
{
    namespace Scimitar
    {
        ...
        struct Pad
        {
            ...
            // Functions defined in the plugin for now
        ...
        struct PadData
        {
            ...
            char _extra_padding[20];       // 0x218 -> 0x22C
        };
        // 4 + 528 + 4 + 20 = 556 (0x22C)
        ...
        struct PadProxyPC : Pad
        {
            ...
            PadData pads[NbPadSets]; // 0x5BC -> 0x171C
            char _tail_padding[0x84]; // 0x171C -> 0x17A0 (Align)

            bool AddPad(Pad* a, PadType b, const wchar_t* c, uint16_t d, uint16_t e, int64_t f, int64_t g);
